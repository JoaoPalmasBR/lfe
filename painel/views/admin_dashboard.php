...
<head>
    <meta charset="UTF-8">
    <title>Admin Geral | LFE SaaS</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-admin-dark mb-4 shadow">
        <div class="container-fluid px-4">
            <a class="navbar-brand fw-bold" href="#">
                <i class="bi bi-shield-lock-fill me-2"></i> Painel Super Admin
            </a>
            <div class="d-flex text-white align-items-center">
                <span class="me-3 small opacity-75">Logado como: <?php echo htmlspecialchars($currentUserFront['nome_completo']); ?></span>
